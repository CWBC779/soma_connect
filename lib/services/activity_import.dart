...
/// Result of parsing an uploaded activities CSV.
class ImportPreview {
  ...
  static ImportPreview parseCsv(List<int> bytes) {
    try {
      ...
      for (var r = 1; r < table.length; r++) {
        ...
        if (date == null || distKm == null || distKm <= 0 || secs == null || secs <= 0) {
          skipped++;
          continue;
        }
        runs++;
        ...
        rows.add({
          'user_id': uid,
          'source': 'upload',
          'external_id': '${date.millisecondsSinceEpoch}_${(distKm * 1000).round()}',
